    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className={`mb-8 p-6 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-blue-50 border border-blue-100'}`}>
        <p className={`text-lg leading-relaxed ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
          Motivated and adaptable ICT professional based in Malawi, passionate about contributing to Malawi's ICT growth and development. I hold a BSc in Computer Systems and Security from MUST and bring hands-on experience across IT service management, cybersecurity, infrastructure deployment, and ATM operations. I'm dedicated to continuous learning and applying emerging technologies to real-world challenges.
        </p>
      </div>
      ...
      <h2 className={`text-2xl font-bold mt-12 mb-6 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Certifications</h2>
      <ul className={`space-y-3 mb-12 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
        {[
          'BSc in Computer Systems and Security — Malawi University of Science and Technology (MUST)',
